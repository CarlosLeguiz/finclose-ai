...
# Realistic account names per type, used by generate_accounts() in dimensions.py.
# Each list must have at least as many entries as ACCOUNT_DISTRIBUTION specifies.
# Names reflect a typical Argentine mid-size manufacturing company's chart of accounts.
REALISTIC_ACCOUNT_NAMES = {
    ...
    "Expense": [
        ...
        "Energía Eléctrica Productiva",
        "Gastos de Marketing",
        "Publicidad",
        "Comisiones a Vendedores",
        "Viajes y Viáticos",
        "Capacitación",
        "Papelería e Insumos Oficina",
